...
public class Audios extends AppCompatActivity {
    ...
    private Button audioAcinco, audioAseis, audioBcero;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  playPauseButton = findViewById(R.id.button_a5);
        volumeUpButton = findViewById(R.id.button_volume2);
        volumeDownButton = findViewById(R.id.button_volume1);
        audioAcinco = findViewById(R.id.button_a5);
        audioAseis = findViewById(R.id.button_a6);
        audioBcero = findViewById(R.id.button_b0);
        ...
        audioAcinco.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        audioAseis.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        audioBcero.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
